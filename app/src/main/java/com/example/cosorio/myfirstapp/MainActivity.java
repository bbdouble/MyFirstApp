package com.example.cosorio.myfirstapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textSize = (SeekBar) findViewById(R.id.seekBar_works);
        second = (SeekBar) findViewById(R.id.seekBar);
        textToGrow = (TextView) findViewById(R.id.toGrow);
        rate = (RatingBar) findViewById(R.id.toGrow);
